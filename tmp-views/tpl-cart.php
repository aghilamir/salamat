                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo pt-40">
                                <a href="index.html">
                                    <h3 class="font-weight-bold">Salamat.ir</h3>
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class="shopping-cart-content">
                                        ...
                                        <div class="shopping-cart-bottom">
                                            ...
                                            <div class="shopping-cart-btn btn-hover text-center">
                                                ...
                                                <a class="default-btn" href="cart.php">
                                                    سبد خرید
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-6">
                            <div class="mobile-logo">
                                <a href="index.html">
                                    <h4 class="font-weight-bold">Salamat.ir</h4>
                                </a>
                            </div>
                        </div>
                        <div class="col-6">
        ...
        <div class="cart-main-area pt-95 pb-100 text-right" style="direction: rtl;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <form action="http://localhost/medical/checkout.php" method="POST">
                                     ...
                                     <?php foreach($products as $product):?>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="#"><img width="100" src="assets/uplode/<?=$product->image?>" alt=""></a>
                                            </td>
                                            <td class="product-name"><a href="#"> <?=$product->name?> </a></td>
                                            <td class="product-price-cart"><span class="amount">
                                               <?php if(isset($_POST['price_chosen'])):?>
                                                <?=$_POST['price_chosen']?>
                                                تومان
                                                <?php else: ?>
                                                    <?=$product->price?>
                                            ...
                                            <td class="product-quantity">
                                                <div class="cart-plus-minus">
                                                    <input class="cart-plus-minus-box" type="text" name="qtybutton"
                                                        value="<?=$_POST['qtybutton']?>">
                                                </div>
                                            </td>
                                            <td class="product-subtotal">
                                                <?php if(isset($_POST['price_chosen'])):?>
                                                <?=$_POST['qtybutton'] * $_POST['price_chosen']?>
                                                تومان
                                                <?php else:?>
                                                    <?=$_POST['qtybutton'] * $product->price?>
                                                <?php endif;?>
                                            </td>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="grand-totall">
                                    ...
                                    <div class="total-shipping">
                                        ...
                                        <p>فقط با وارد کردن شماره تلفن خود محصصول خود را ثبت کنید تا کارشناسان ما با شما در تماس باشند</p>
                                    
                                        <input type="text" required="" name="user_cellphone">
                                    ...
                                    <?php if(isset($_POST['price_chosen']) and $_POST['price_chosen']==$product->sale_price ):?>
                                        <?=(int)1?>
                                        <?php else:?>
                                            <?=(int)0?>
                                        <?php endif;?>
...
============================================ -->
    ...
    <!-- jQuery JS -->
<script src="<?=BASE_URL?>assets/js/home/jquery-1.12.4.min.js"></script>
<script src="<?=BASE_URL?>assets/js/home/plugins.js"></script>
